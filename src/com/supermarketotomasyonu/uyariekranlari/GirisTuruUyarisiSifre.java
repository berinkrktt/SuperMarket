 ...
 */
public class GirisTuruUyarisiSifre extends javax.swing.JFrame {

    int mouseX, mouseY;

    public GirisTuruUyarisiSifre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        uyarıLogo.setForeground(new java.awt.Color(79, 114, 0));
        uyarıLogo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        uyarıLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/supermarketotomasyonu/images/uyari.jpg"))); // NOI18N
        ...
        mesajYazisi.setText("Şifrenizi Değiştirebilmek İçin Giriş Türünüzü Seçiniz!");
        ...
        bilgiYazisi.setText("Logonun altında bulunan butonlardan giriş türünüzü seçtikten sonra şifrenizi değiştirebilirsiniz.");
        ...
        formLayout.setHorizontalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(uyarıLogo, javax.swing.GroupLayout.DEFAULT_SIZE, 622, Short.MAX_VALUE)
                    .addComponent(mesajYazisi, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(GirisTuruUyarisiSifre.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new GirisTuruUyarisiSifre().setVisible(true);
        });
    }
