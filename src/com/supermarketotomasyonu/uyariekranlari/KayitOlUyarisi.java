 ...
 */
public class KayitOlUyarisi extends javax.swing.JFrame {

    int mouseX, mouseY;

    public KayitOlUyarisi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mesajYazisi.setText("Lütfen Bilgilerinizi Eksiksiz Girdiğinizden Emin Olun!");
        ...
        bilgiYazisi.setText("Kayıt işleminin başarılı olabilmesi için bilgilerinizi eksiksiz ve doğru giriniz.");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(KayitOlUyarisi.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new KayitOlUyarisi().setVisible(true);
        });
    }
