 ...
 */
public class SifreDegistirUyarisi extends javax.swing.JFrame {

    int mouseX, mouseY;

    public SifreDegistirUyarisi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mesajYazisi.setText("Lütfen Girdiğiniz Bilgileri Kontrol Ediniz.");
        ...
        bilgiYazisi.setText("Giriş Türünüzü doğru seçtiğinizden, kullanıcı adınızı ve mail adresinizi doğru girdiğinizden emin olunuz.");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SifreDegistirUyarisi.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new SifreDegistirUyarisi().setVisible(true);
        });
    }
