 ...
 */
public class SifreDegistirildiBildirimiAnaEkran extends javax.swing.JFrame {

    int mouseX, mouseY;

    public SifreDegistirildiBildirimiAnaEkran() {
        initComponents();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SifreDegistirildiBildirimiAnaEkran.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new SifreDegistirildiBildirimiAnaEkran().setVisible(true);
        });
    }
