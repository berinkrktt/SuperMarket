 ...
 */
public class SifrelerUyusmuyorUyarisi extends javax.swing.JFrame {

    int mouseX, mouseY;

    public SifrelerUyusmuyorUyarisi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mesajYazisi.setText("Girdiğiniz Şifreler Uyuşmamaktadır!");
        ...
        bilgiYazisi.setText("Yeni Şifre ve Yeni Şifre Doğrulama alanları kısmına girdiğiniz şifrelerin aynı olduğundan emin olunuz.");
        ...
        formLayout.setHorizontalGroup(
            ...
            .addGroup(formLayout.createSequentialGroup()
                ...
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(uyariLogo, javax.swing.GroupLayout.DEFAULT_SIZE, 622, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SifrelerUyusmuyorUyarisi.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SifrelerUyusmuyorUyarisi().setVisible(true);
            }
        });
    }
