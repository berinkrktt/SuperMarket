 ...
 */
public class SifreAlaniBosUyarisi extends javax.swing.JFrame {

    int mouseX, mouseY;

    public SifreAlaniBosUyarisi() {
        initComponents();
    ...
    private void initComponents() {
        ...
        mesajYazisi.setText("Lütfen Şifre Alanlarını Doldurunuz!");
        ...
        bilgiYazisi.setText("Yeni Şifre ve Yeni Şifre Doğrulama alanları kısmına şifrenizi girdiğinizden emin olunuz.");
        ...
        formLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, formLayout.createSequentialGroup()
                ...
                .addGroup(formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(bilgiYazisi, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 575, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SifreAlaniBosUyarisi.class
                    .getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new SifreAlaniBosUyarisi().setVisible(true);
        });
    }
