...
public class SifreDegistirEkran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        separator.setBackground(new java.awt.Color(79, 114, 0));
        separator.setForeground(new java.awt.Color(79, 114, 0));
        separator.setToolTipText("");
        separator.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        separator.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        separator.setMinimumSize(new java.awt.Dimension(50, 50));
        separator.setSize(new java.awt.Dimension(50, 20));
