...
import com.supermarketotomasyonu.uyariekranlari.SifreDegistirUyarisi;
import com.supermarketotomasyonu.uyariekranlari.SifreDegistirildiBildirimiAnaEkran;
import com.supermarketotomasyonu.uyariekranlari.SifrelerUyusmuyorUyarisi;
import com.supermarketotomasyonu.yonetici.YoneticiIslemleri;
...
public class SifreDegistirEkran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kullaniciAdiYazisi.setToolTipText("Lütfen kullanıcı adınızı giriniz.");
        ...
        kullaniciAdiAlani.setToolTipText("Lütfen kullanıcı adınızı giriniz.");
        ...
        mailAdresiYazisi.setToolTipText("Hesabınızın bağlı olduğu mail adresini giriniz.");
        ...
        mailAdresiAlani.setToolTipText("Hesabınızın bağlı olduğu mail adresini giriniz.");
    ...
    private void kapamaButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kapamaButtonMouseClicked
        SupermarketOtomasyonu.kontrolSayisi = 0;
    ...
    private void sifreDegistirButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sifreDegistirButtonActionPerformed
        ...
        String mailAdresi = mailAdresiAlani.getText();
        ...
        if (!(sifreKontrol || sifreDogrulamaKontrol)) {
            if (kontrol) {
                boolean bilgiler = false;

                switch (SupermarketOtomasyonu.kontrolSayisi) {
                    case 1:
                        bilgiler = yoneticiIslemleri.isSifreDegistir(kullaniciAdi, mailAdresi);
                        break;
                    case 2:
                        bilgiler = calisanIslemleri.isSifreDegistir(kullaniciAdi, mailAdresi);
                        break;
                    case 3:
                        bilgiler = kullaniciIslemleri.isSifreDegistir(kullaniciAdi, mailAdresi);
                        break;
                }
                ...
                if (bilgiler) {
                    switch (SupermarketOtomasyonu.kontrolSayisi) {
                        case 1:
                            yoneticiIslemleri.sifreDegistir(kullaniciAdi, sifre);
                            break;
                        case 2:
                            calisanIslemleri.sifreDegistir(kullaniciAdi, sifre);
                            break;
                        case 3:
                    ...
                    SifreDegistirildiBildirimiAnaEkran sifreDegistirildiBildirimEkran = new SifreDegistirildiBildirimiAnaEkran();
                    sifreDegistirildiBildirimEkran.setVisible(true);
                    setVisible(false);
                } else {
                    SifreDegistirUyarisi sifreDegistirUyarisi = new SifreDegistirUyarisi();
                    sifreDegistirUyarisi.setVisible(true);
                }
            } else {
